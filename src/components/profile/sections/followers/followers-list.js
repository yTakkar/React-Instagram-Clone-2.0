...
class FollowersList extends Component {
  ...
  render() {
    let { follow_by, username, firstname, surname, follow_time, id } = this.props
    ...
    return (
      ...
      >
        <MonTopInfo
          info={{ user: follow_by, username, firstname, surname }}
        />
        ...
        <div className='m_bottom'>
          {
            Me(follow_by)
              ...
              : isFollowing
                ...
                : <Follow
                  userDetails={{
                    user: follow_by, username, firstname, surname
                  }}
